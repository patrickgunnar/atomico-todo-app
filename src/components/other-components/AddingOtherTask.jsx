...
import styles from './AddingOtherTask.module.css'
...
const AddingOtherTask = ({ isFavourite=true }) => {
    ...
    // render elements
    return (
        <section className={styles.other_add_task__main_section}>
            <div className={styles.other_add_task__main_from_box}>
                <div className={styles.other_add_task__main_content_title_box}>
                    <p>Add New Task</p>
                </div>
                <div className={styles.other_add_task__main_content_form_box}>
                    <form onSubmit={submitHandler}>
                        <label className={styles.other_add_task__main_content_label}>Select List:</label>
                        <select ref={currentInputListRef} required className={styles.other_add_task__main_content_input}>
                            {currentElementsOption}
                        </select>
                        <label className={styles.other_add_task__main_content_label}>Task Date:</label>
                        <input ref={currentInputDateRef} type='date' required
                                className={styles.other_add_task__main_content_input} />
                        <label className={styles.other_add_task__main_content_label}>Task Content:</label>
                        <textarea ref={currentInputTaskRef} required placeholder='Content of task'
                                className={styles.other_add_task__main_content_textarea}></textarea>
                        <div className={styles.other_add_task__main_content_btn_box}>
                            <input type='button' value='Cancel' onClick={_ => contentHandler([])}
                                    className={styles.other_add_task__main_content_btn} />
                            <button className={styles.other_add_task__main_content_btn}>Add</button>
                        </div>
                    </form>
                </div>
            </div>
...
export default AddingOtherTask
